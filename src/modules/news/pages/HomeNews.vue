<template>
  <div class="mt-8 min-h-screen space-y-5">
    <CommonSlider :slides="['1', '2', '3', '4', '5']" :itemsToShow="3">
      <template #slideItem>
        <div class="flex w-[90%] items-center gap-2 rounded-sm bg-white">
          <img
    ...
    <div class="grid grid-cols-3 gap-5">
      <CommonSlider
        :slides="['1', '2', '3', '4', '5']"
        :itemsToShow="1"
        class="news-image-slider col-span-2"
      >
        <template #slideItem>
          <CardNews
      ...
      <div class="col-span-1 space-y-5">
        <div
          class="flex h-[50px] items-center justify-between bg-white px-4 py-2"
        >
    ...
    <div class="grid grid-cols-3 gap-5">
      ...
      <RightSection class="col-span-1 flex flex-col"> </RightSection>
    </div>
  </div>
</template>
